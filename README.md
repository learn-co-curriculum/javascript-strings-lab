...
## Objectives
1. Learn how to run the test suite for a JavaScript lab on Learn.co.
2. Practice reading failing tests and working through a JavaScript test suite.
...
<p class='util--hide'>View <a href='https://learn.co/lessons/javascript-strings-lab'>JavaScript Strings Code-along</a> on Learn.co and start learning to code for free.</p>
